      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "flex-end", marginBottom: 8, animation: "fadeUp 0.4s ease-out" }}>
        {user ? (
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <button onClick={signOut} style={{ background: "none", border: "1px solid rgba(191,155,48,0.15)", borderRadius: 8, padding: "4px 10px", cursor: "pointer", color: "rgba(245,236,215,0.35)", fontFamily: S.body, fontSize: 11 }}>{t("common.signOut")}</button>
          </div>
        ) : (
