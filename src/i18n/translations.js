...
const enUS = {
  common: {
    ...
    signInPopupBlocked: "If the sign-in window didn't open, allow popups for this site and try again.",
    back: "←",
  ...
  examen: {
    ...
    signInToSave: "Sign in with Google to save your reflections.",
    continueWithoutSaving: "Continue without saving",
    completeNoSave: "You completed the Examen. Sign in next time to save your reflections.",
    completeInviteWrite: "Next time you can write your reflections in each step.",
    step: "Step {n}/5",
...
function getEsContent() {
  return {
    ...
    commandmentExam: [
      ...
      { commandment: "8.º — No darás falso testimonio ni mentirás.", questions: ["¿He mentido?", "¿He chismeado sobre otros a sus espaldas?", "¿He dañado la reputación de alguien con mentiras?", "¿He revelado información privada que debería mantenerse en secreto?", "¿He fallado en defender la verdad cuando era necesario?"] },
...
const esES = {
  common: {
    ...
    loadingSignIn: "Cargando…",
    signInPopupBlocked: "Si no se abrió la ventana de inicio de sesión, permite las ventanas emergentes de este sitio e inténtalo de nuevo.",
    back: "←",
  ...
  examen: {
    ...
    signInToSave: "Inicia sesión con Google para guardar tus reflexiones.",
    continueWithoutSaving: "Continuar sin guardar",
    completeNoSave: "Completaste el Examen. Inicia sesión la próxima vez para guardar tus reflexiones.",
    completeInviteWrite: "La próxima vez puedes escribir tus reflexiones en cada paso.",
    step: "Paso {n}/5",
